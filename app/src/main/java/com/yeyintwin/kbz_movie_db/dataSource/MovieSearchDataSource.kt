...
class MovieSearchDataSource(private val searchKey: String) : PagingSource<Int, MovieModel>(){
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieModel> {
        ...
        try {
            ...
            val response = ServiceHelper.api.searchMovie(searchKey, currentLoadingPageKey)
